...
int [] sync= new int[0];
  ...
  private void regle43() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_43(x_3, x_4);
	x_2.analyser(LEX_Bloc.token_virgule);
	x_3.analyser() ;
	x_4.analyser() ;
if  (att_eval)	  action_ast_43(x_3, x_4);
  }
...
private void action_auto_inh_43(S_Expression_Bloc x_3, S_SuiteExpressions_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_ast_43(S_Expression_Bloc x_3, S_SuiteExpressions_Bloc x_4) throws Exception {
try {
// instructions
