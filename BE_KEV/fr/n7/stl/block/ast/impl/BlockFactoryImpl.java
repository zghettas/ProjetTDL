...
public class BlockFactoryImpl implements BlockFactory {
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.block.ast.TypeFactory#createAddressAccess()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.block.ast.TypeFactory#createPointerAllocation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.block.ast.TypeFactory#createArrayAllocation()
	 */
	@Override
