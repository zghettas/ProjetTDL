...
if  (att_eval)	  action_auto_inh_58(x_2, x_3);
	x_2.analyser() ;
	x_3.analyser() ;
if  (att_eval)	  action_champs_58(x_2, x_3);
  }
  private void regle59() throws Exception {

	//declaration
	//appel
if  (att_eval)	  action_champs_59();
  }
private void action_champs_59() throws Exception {
try {
// instructions
...
private void action_champs_58(S_Champ_Bloc x_2, S_Champs_Bloc x_3) throws Exception {
try {
// locales
...
private void action_auto_inh_58(S_Champ_Bloc x_2, S_Champs_Bloc x_3) throws Exception {
try {
// instructions
