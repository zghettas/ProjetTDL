...
//modifé type de retour en Assignable pour corriger une erreur sur la regle //Affectable -> multiplication Affectable
	/**
	...
	/* (non-Javadoc)
	*/
	public Expression createAdressAccess (Assignable _aff);
	...
	/* (non-Javadoc)
	 */
	public Expression createArrayAllocation (Type _type, Expression _mem);
}
