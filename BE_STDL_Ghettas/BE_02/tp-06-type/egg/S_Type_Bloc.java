...
if  (att_eval)	  action_ast_47(x_2);
  ...
  private void regle48() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_48(x_3, x_6);
...
if  (att_eval)	  action_inh_48(x_3, x_6);
	x_6.analyser() ;
	x_7.analyser(LEX_Bloc.token_accolade_fermante);
if  (att_eval)	  action_ast_48(x_3, x_6);
  }
private void action_ast_47(T_Bloc x_2) throws Exception {
try {
// locales
...
private void action_ast_48(T_Bloc x_3, S_Champs_Bloc x_6) throws Exception {
try {
// instructions
glob_48_t.addAll(x_6.att_champs);
this.att_ast=glob_48_t;
...
private void action_auto_inh_48(T_Bloc x_3, S_Champs_Bloc x_6) throws Exception {
try {
// instructions
...
private void action_inh_48(T_Bloc x_3, S_Champs_Bloc x_6) throws Exception {
try {
// instructions
...
glob_48_t=this.att_factory.createRecordType(x_3.att_txt);
this.att_tds.register(glob_48_t);
}
